            ...
            if ml_pred_label:
                ...
                st.markdown(
                    ...
                    <div style="text-align: center; padding: 2.5rem; border-radius: 12px; background-color: {ml_bg_color}; border: 2px solid {ml_color}; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-top: 2rem; margin-bottom: 1rem;">
                        ...
                        <p style="margin: 4px 0 0 0; font-size: 1rem; color: black;">Predicting the price movement for the first candle of the day so that you can close your AMO position by 10:15 AM.</p>
